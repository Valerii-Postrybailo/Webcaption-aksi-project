...
const workingTime1 = document.querySelector(".first-working-time")
const workingTime2 = document.querySelector(".second-working-time")
...
mapBtn1.addEventListener("click", () => {
  ...
  workingTime1.innerHTML = `<span class="location-box__address-block-data">ПН - ПТ</span>10:00–20:00`;
  workingTime2.innerHTML = `<span class="location-box__address-block-data ">СБ - НД</span>10:00–16:00`;
});
...
mapBtn3.addEventListener("click", () => {
  ...
  address.href = "https://bit.ly/406ZjI2";
    workingTime1.innerHTML = `<span class="location-box__address-block-data">ПН - ПТ</span>8:00–18:00`;
  workingTime2.innerHTML = `<span class="location-box__address-block-data ">СБ - НД</span>8/9:00–16:00`;
});
